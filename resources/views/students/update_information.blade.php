                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input disabled type="text" class="form-control text-truncate" value="{{Auth::user()->user_name}}"/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="email_address">Email<span class="text-danger">*</span></label>
                                <input disabled type="text" class="form-control text-truncate" value="{{Auth::user()->email_address}}"/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
